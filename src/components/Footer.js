    ...
    <div>
      <div className="container text-white pb-5">
        ...
        >
          ...
          />
          <div className="position-absolute top-50 start-50 translate-middle text-white fw-bold justify-content-between d-flex px-5">
            <div
              style={{
                fontSize: "1.5rem",
            ...
            >
              Power Your Future with <br /> Clean, Renewable Energy
            </div>
            <div>
              <a
          ...
          <div className="row border-top border-secondary pt-3 mt-3">
            <div className="col-lg-6">
              <p className="small mb-0">
                © 2025 Krakenbox. All Rights Reserved.
              </p>
            </div>
